...
type EventList = Event & { class: Class | null }; // Make class nullable
...
const EventListPage = async ({
  ...
  const columns = [
    ...
    {
      header: "Class",
      accessor: "class.name", // Access the class name directly
    },
    {
      header: "Start Time",
      accessor: "startTime",
  ...
  const renderRow = (item: EventList) => (
    ...
    >
      ...
      {/* Show class name or a placeholder */}
  ...
  const [data, count] = await prisma.$transaction([
    prisma.event.findMany({
      where: query,
      include: {
        class: true, // Include the class to fetch its data
      },
      take: ITEM_PER_PAGE,
